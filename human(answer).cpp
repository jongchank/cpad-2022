...
static void common_drive(int index, tCarElt* car, tSituation *s)
{
	...
	car_speed = (car->pub.speed)*3.6; // km/h
	car_angle = 180/PI*(car->_yaw); // deg
	car_rpm = car->_enginerpm*30/PI; // rpm
	...
	yaw_value = (short)(car_angle);
	//yaw_value = (short)(car_angle*100);
	yaw_1b = (yaw_value&0xFF00)>>8;
	yaw_2b = yaw_value&0x00FF;
